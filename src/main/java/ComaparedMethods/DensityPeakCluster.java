...
//import datainput.DataReader;
//import datainput.Sample;
...
//		}
	...
	public void calDelta() {
		//局部密度由大到小排序
		sortedDensityList = new ArrayList<Entry<Integer,Integer>>(densityCountMap.entrySet());
		Collections.sort(sortedDensityList, new Comparator<Entry<Integer, Integer>>() {
