...
//        Dataset<Row> st = spark.read().csv("data/DS3.csv");
        //保证数据的顺序
...
//        System.out.println("分区数"+listJavaRspRDD1.rdd().getNumPartitions());
        ...
        for (int i = 0; i < numberOfCluster; i++) {
                centermeage.add(collect.get(cluster.getCenterList().get(i)));
        }
        ClusterRuns.add((double) centermeage.size());
